...
from agentkit.identity.jwt import OidcJwtVerifier, WorkloadJwtVerifier
from agentkit.identity.types import (
    DelegationReceipt,
...
if TYPE_CHECKING:
    from agentkit.identity.transport import AuthorizedSession
...
class RuntimeIdentity:
    ...
    def verify_inbound(self, authorization: str | None) -> IdentityContext:
        """Verify one inbound credential and return token-free identity metadata."""
