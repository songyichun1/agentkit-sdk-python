...
from agentkit_identity.errors import TargetNotConfiguredError, TargetRequestError
        ...
        **kwargs: Any,
        ...
        if (
            ...
            raise ValueError(
                ...
                f"no greater than {_MAX_TIMEOUT_SECONDS:g} seconds"
            )
        ...
        *,
        ...
        try:
            ...
            if not isinstance(response, requests.Response):
                return None
            # The protected transport is bearer-only. Do not let a downstream
            # service mint an unmanaged session credential through Response
            # cookies or retain the TIP in the PreparedRequest/raw connection.
            _ = response.content
